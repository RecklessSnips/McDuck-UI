  ...
  <div class="surface-ground px-4 py-8 md:px-6 lg:px-8">
    ...
    <div class="surface-card grid grid-nogutter border-round shadow-2">
      ...
      <div class="col-12">
        ...
        >
          <div class="flex flex-column lg:flex-row justify-content-center align-items-center px-2">
            <img
              src="/src/assets/images/Screenshot 2024-07-30 at 3.20.57 PM.png"
              alt="product"
            ...
            <div class="flex flex-column my-auto text-center md:text-left">
              <span class="text-900 font-medium mb-3 mt-3 lg:mt-0"
                >Product Name Placeholder A Little Bit Long One</span
              >
      ...
      <div class="col-12 p-0 flex border-top-1 surface-border">
        <a
          tabindex="0"
          class="cursor-pointer py-4 flex flex-column md:flex-row text-center justify-content-center align-items-center font-mediu7 text-primary hover:bg-primary hover:text-0 transition-duration-150 w-full"
